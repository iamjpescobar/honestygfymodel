...
st.markdown(
    ...
    f'<div style="color:{COLOR["text_muted"]}; font-size:var(--lc-text-small);">Matchup pages for every slate — team ratings, pace, and lineup context</div>'
    f'</div>',
    unsafe_allow_html=True,
)
st.markdown(
    f'<div style="margin-bottom:var(--lc-space-lg);">'
    f'<div style="font-weight:700; color:{COLOR["text"]}; font-size:var(--lc-text-body);">Player Analytics</div>'
    f'<div style="color:{COLOR["text_muted"]}; font-size:var(--lc-text-small);">Usage, shot quality, and matchup-driven player breakdowns</div>'
    f'</div>',
    unsafe_allow_html=True,
)
st.markdown(
    f'<div style="margin-bottom:var(--lc-space-lg);">'
    f'<div style="font-weight:700; color:{COLOR["text"]}; font-size:var(--lc-text-body);">Prop Models</div>'
    f'<div style="color:{COLOR["text_muted"]}; font-size:var(--lc-text-small);">Composite scores built the same way the MLB engines were</div>'
    f'</div>',
    unsafe_allow_html=True,
)
st.markdown(card_close(), unsafe_allow_html=True)
