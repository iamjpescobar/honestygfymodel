...
st.markdown(
    ...
    f'<div style="color:{COLOR["gold"]}; font-size:var(--lc-text-small);">Matchup pages for every slate — team ratings, pace, and lineup context</div>'
    f'</div>',
    unsafe_allow_html=True,
)
st.markdown(
    ...
    f'<div style="color:{COLOR["gold"]}; font-size:var(--lc-text-small);">Usage, shot quality, and matchup-driven player breakdowns</div>'
    f'</div>',
    unsafe_allow_html=True,
)
st.markdown(
    ...
    f'<div style="color:{COLOR["gold"]}; font-size:var(--lc-text-small);">Composite scores built the same way the MLB engines were</div>'
    f'</div>',
    unsafe_allow_html=True,
)
st.markdown(card_close(), unsafe_allow_html=True)
